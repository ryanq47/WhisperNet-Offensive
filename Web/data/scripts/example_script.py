...
class on_agent_connect:
    async def run(data):
        ...
        await interface.broadcast(
            "Hello from custom broadcast in on_agent_connect in script"
        )
...
class on_agent_first_connect:
    async def run(data):
        ...
        await interface.broadcast(
            "Hello from custom broadcast in on_agent_first_connect in script"
        )
...
class on_agent_data:
    async def run(data):
        await interface.broadcast(
            "Hello from custom broadcast in on_agent_data in script"
        )
